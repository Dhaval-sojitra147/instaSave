...
class ScrollingFeedIndicator extends StatefulWidget {
  ...
  State<StatefulWidget> createState() {
    return _ScrollingFeedIndicatorState();
  }
}

class _ScrollingFeedIndicatorState extends State<ScrollingFeedIndicator> {
  ...
  @override
  void didUpdateWidget(ScrollingFeedIndicator oldWidget) {
...
class _Painter extends CustomPainter {
  final ScrollingFeedIndicator _widget;
  final double _page;
  final Paint _paint;
  final Axis orientation;
